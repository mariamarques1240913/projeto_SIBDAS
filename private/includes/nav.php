...
<nav class="navbar navbar-dark sticky-top shadow-sm">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="/projeto_SIBDAS/private/dashboard.php">
            <img src="/projeto_SIBDAS/assets/img/logotipo_hospital.png" alt="Logo Hospitally" height="52" class="d-inline-block align-text-top me-2 my-n2" style="margin-top: -8px; margin-bottom: -8px;">
